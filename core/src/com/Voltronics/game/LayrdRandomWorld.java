...
public class LayrdRandomWorld implements ContactListener, GestureListener{


    public enum worldState{READY, PLAYING, PAUSED, LEVELFINISH, GAMEOVER, LOADINGMENU}
    public LayrdRandomWorld.worldState state = worldState.READY;
...
/*
    ...
    private void mapInitialize(){
        ...
        batcher.begin();
        batcher.draw(backGround, 0, 0, 480, 320);
        batcher.end();
